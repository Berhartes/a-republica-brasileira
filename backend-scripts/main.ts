...
import { calcularLegislaturaAtual, importarLegislatura } from "../tools/scripts/modules/legislaturas-module";
import { senadoApiService } from "../src/domains/republica/congresso/senado/services/senado-api.service";
import { getDb, initializeFirebase } from "../backend/firebase-admin-setup/firebase-admin";
