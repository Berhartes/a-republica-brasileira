    ...
    return (
      ...
      >
        <div className="relative">
          ...
          {/* TabSelector removido daqui e adicionado dentro da área de conteúdo */}
        </div>
          ...
          >
            ...
            {isSelected ? (
              ...
              <>
                ...
                {/* Rodapé do dashboard fora da área de conteúdo dos cards */}
...
export const DashboardUnificadoUF = ({ uf: initialUf }: DashboardUnificadoUFProps) => {
  ...
  useEffect(() => {
    ...
    const handleStateChange = (event: any) => {
      // Verificar se a página está visível antes de processar o evento
      if (!isVisible) {
        console.log(`DashboardUnificadoUF: Ignorando evento stateChange porque a página não está visível`);
        return;
      }
