...
import { senadoApiService } from "../services";
import { VotacoesPanel } from "../components";
import { LoadingSpinner } from "../../../../../shared/components/ui/loading-spinner";
import { Card, CardHeader, CardTitle, CardContent } from "../../../../../shared/components/ui/card";
import type { Senador } from '../types/index';
...
const SenadoMapaVotacoes: React.FC<SenadoMapaVotacoesProps> = () => {
  ...
  const { 
    ...
    queryKey: ['senadores'],
    queryFn: async () => {
      const response = await senadoApiService.getSenadores({ page: 1, limit: 100 });
