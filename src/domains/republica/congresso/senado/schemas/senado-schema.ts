...
export const mandatoSchema = z.object({
  ...
  fim: z.date().optional(),
  tipo: z.string(),
  descricao: z.string().optional(), // Adicionado descricao como opcional
...
export const senadorDetalhadoSchema = senadorSchema.extend({
  ...
  ufNascimento: z.string().optional(), // Adicionado ufNascimento
  redes: z.object({
  ...
  redeSocial: z.array(z.object({ // Adicionado redeSocial
    nome: z.string(),
    url: z.string()
  })).optional()
});
