...
import { useSenadorPerfil } from '@/domains/republica/congresso/senado/hooks';
import { useDiscursosSenador } from '@/domains/republica/congresso/senado/hooks/useDiscursosSenador';
...
const SenadorPerfilGenerico: React.FC<SenadorPerfilGenericoProps> = ({ id: propId }: SenadorPerfilGenericoProps) => {
  ...
  const toggleFavorite = () => {
    ...
    localStorage.setItem('favoriteSenadores', JSON.stringify(favorites));
  };
