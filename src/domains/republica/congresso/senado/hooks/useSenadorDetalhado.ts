...
import { 
  ...
  type Comissao, // Alterado de ComissaoSchema para Comissao
} from '@/domains/republica/congresso/senado/schemas';
// Removido bloco de importação de @/domains/republica/congresso/senado/types/index
// Os tipos Materia, Votacao, Despesa também devem vir dos schemas se existirem lá,
// ou serem definidos/importados de um local único se forem tipos específicos da UI/hook.
// Por agora, vamos assumir que SenadorDetalhado, Comissao, Materia, Votacao, Despesa
// são todos exportados de @/domains/republica/congresso/senado/schemas
import { type MateriaSchema as Materia, type VotacaoSchema as Votacao, type DespesaSchema as Despesa } from '@/domains/republica/congresso/senado/schemas'; // Adicionado para Materia, Votacao, Despesa e renomeado
import {
  normalizeSenadorDetalhado
} from '@/domains/republica/congresso/senado/transformers';
