...
import { z } from 'zod';
import { senadoApiClient } from '@/domains/republica/congresso/senado/services/api-client';
import { type Comissao } from '@/domains/republica/congresso/senado/schemas';

// Extend Comissao to include 'ativa' and 'tipo' properties
interface ComissaoResponse extends Comissao {
  ativa: boolean;
  tipo?: string;
}
