...
interface BoardOrcamentoEstadualProps {
  cardData: CardData;
...
export const BoardOrcamentoEstadual: React.FC<BoardOrcamentoEstadualProps> = ({
  cardData,
  onClose,
  isDarkMode,
  style,
  ...
  return (
    <div className="p-4 rounded-lg" style={contentStyle}>
      ...
      <div className="text-sm" style={{ color: textColors.descriptionColor }}>
        {/* O título agora vem de cardData.details.title ou fallback para cardData.title */}
