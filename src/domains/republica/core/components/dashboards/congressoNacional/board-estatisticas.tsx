...
interface BoardEstatisticasProps {
  cardData: CardData;
  config: DashboardConfig;
  onClose: () => void;
  isDarkMode?: boolean;
  ufEstado: string; // Pode ser usado para contextualizar estatísticas
  style: string;
  textColors: TextColorClasses;
  contentStyle: React.CSSProperties;
}

export const BoardEstatisticas: React.FC<BoardEstatisticasProps> = ({
  cardData,
  onClose,
  isDarkMode,
  ufEstado,
