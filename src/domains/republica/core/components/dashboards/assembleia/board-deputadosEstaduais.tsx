...
interface BoardDeputadosEstaduaisProps {
  cardData: CardData;
...
export const BoardDeputadosEstaduais: React.FC<BoardDeputadosEstaduaisProps> = ({
  cardData,
  onClose,
  isDarkMode,
  style,
  ...
  // O conteúdo HTML de cardData.content será convertido para JSX aqui
  // Por enquanto, vamos usar dangerouslySetInnerHTML como placeholder
  // Isso será substituído por JSX seguro e estruturado.
  ...
  return (
    <div className="p-4 rounded-lg" style={contentStyle}>
      ...
      {/* Conteúdo específico do board, agora vindo de cardData */}
