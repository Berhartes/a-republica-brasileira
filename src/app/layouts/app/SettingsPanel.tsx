...
import { useDashboardStyle } from "@/domains/republica/core/contexts/DashboardStyleContext";
      ...
      <SheetContent className="bg-gray-900 text-white">
        ...
        <div className="flex flex-col gap-4 mt-8">
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <h3 className="font-medium text-gray-300">Admin</h3>
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-400">Modo Admin</span>
                <button
                  className={`w-10 h-5 rounded-full relative ${isAdminMode ? 'bg-blue-600' : 'bg-gray-600'}`}
