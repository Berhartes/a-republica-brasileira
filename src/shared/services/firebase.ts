...
// Usando variáveis de ambiente de forma compatível com Vite e Node.js
...
const useEmulators = (import.meta.env?.VITE_USE_FIREBASE_EMULATOR || process.env.VITE_USE_FIREBASE_EMULATOR) === 'true';
