...
async function validacaoFinal() {
  ...
  try {
    ...
    const cli = new ETLCommandParser('teste', 'Teste CLI');
    ...
    const cliDespesas = new ETLCommandParser('camara:despesas', 'Processador de Despesas');
    ...
    const cliDiscursos = new ETLCommandParser('camara:discursos', 'Processador de Discursos');
    ...
    const cliSemLegislatura = new ETLCommandParser('teste', 'Teste Sem Legislatura');
