...
exports.importarSenado = functions.https.onRequest(async (req, res) => {
    try {
        // Altere a URL abaixo para o endpoint do seu wrapper local
        const response = await axios_1.default.get('http://localhost:3000/api/senado/exemplo');
