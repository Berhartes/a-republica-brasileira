  ...
  private setupInterceptors(): void {
    ...
    this.client.interceptors.request.use(
      (config) => {
        ...
        // O logger.apiRequest foi removido pois o console.log acima já cumpre uma função similar
        // e para simplificar o código, dado que estava comentado.
        // Se um log mais estruturado for necessário no futuro, pode ser reintroduzido.
