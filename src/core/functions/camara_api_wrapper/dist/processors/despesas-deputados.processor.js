...
import { createBatchManager } from '../utils/storage'; // Remover createMultiBatchManager
import { db } from '../utils/storage/firestore/config'; // Importar db para leitura
 ...
 */
export class DespesasDeputadosProcessor extends ETLProcessor {
    constructor(options) {
        super(options);
    }
    /**
    ...
    async extractDespesasCompletas(deputadoId) {
        ...
        try {
            ...
            const todasDespesas = await apiClient.getAllPages(endpoint, baseParams, {
