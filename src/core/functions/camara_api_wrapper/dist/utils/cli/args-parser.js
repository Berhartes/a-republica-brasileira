 ...
 */
export function getBooleanOption(options, key, defaultValue = false) {
 ...
 */
export function getNumberOption(options, key, defaultValue) {
    if (options[key] === undefined) {
        return defaultValue;
    }
 ...
 */
export function exibirAjuda(scriptName, opcoesEspecificas = '', exemplosEspecificos = '') {
    const opcoesComuns = `
