...
// Tipos Específicos para o Módulo de Composição
...
export interface Lideranca {
  ...
  DescricaoTipoLideranca: string; // Ex: "Líder do Partido", "Líder do Bloco"
  DescricaoUnidadeLideranca: string; // Ex: "Partido", "Bloco", "Governo"
...
export interface FiltrosListarBlocos extends BaseApiFilters {
  // Filtros específicos para blocos, se houver
}

export interface FiltrosListarLiderancas extends BaseApiFilters {
  // Filtros específicos para lideranças, se houver
}

export interface FiltrosListarPorTipo extends BaseApiFilters {
  tipo: string;
  casa?: "SF" | "CN"; // Para endpoints que aceitam casa
}
...
export class ComposicaoModule {
   ...
   */
  public async listarPartidos(filtros?: FiltrosListarPartidos): Promise<Partido[]> {
    const url = "/composicao/lista/partidos";
    try {
      const response = await this.httpClient.get<any>(url, { params: filtros });
   ...
   */
  public async listarBlocosParlamentares(filtros?: FiltrosListarBlocos): Promise<BlocoParlamentar[]> {
   ...
   */
  public async obterDetalhesBloco(codigoBloco: Codigo): Promise<DetalheBlocoParlamentar | null> {
   ...
   */
  public async listarLiderancas(filtros?: FiltrosListarLiderancas): Promise<Lideranca[]> {
   ...
   */
  public async listarTiposLideranca(): Promise<TipoLideranca[]> {
   ...
   */
  public async listarTiposUnidadeLideranca(): Promise<UnidadeLideranca[]> {
   ...
   */
  public async listarTiposCargo(): Promise<TipoCargo[]> {
   ...
   */
  public async listarComposicaoPorTipo(filtros: FiltrosListarPorTipo): Promise<any[]> {
    if (!filtros.tipo) {
   ...
   * @param filtros - Filtros com tipo de composição.
   */
  public async listarComposicaoCNPorTipo(filtros: FiltrosListarPorTipo): Promise<any[]> {
    if (!filtros.tipo) {
      throw new WrapperError("O tipo de composição é obrigatório.");
    }
   ...
   */
  public async obterComposicaoResumidaComissaoMista(filtros: FiltrosComposicaoResumida): Promise<ComposicaoComissaoResumida | null> {
   ...
   */
  public async obterComposicaoMesa(casa: "SF" | "CN"): Promise<ComposicaoMesa | null> {
