...
exports.testarCorrecoes = testarCorrecoes;
...
const discursos_processor_1 = require("./processors/discursos.processor");
...
async function testarCorrecoes() {
    try {
        ...
        const options = {
            legislatura: 56,
            limite: 2,
            destino: 'pc', // 'pc' é um valor válido para o tipo literal
            verbose: true,
            dryRun: true
            // Outras propriedades opcionais de ETLOptions podem ser adicionadas se necessário
        };
        const processor = new discursos_processor_1.DiscursosProcessor(options);
...
//# sourceMappingURL=test-discursos-fix.js.map